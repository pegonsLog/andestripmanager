// Barrel exports para componentes de clima
export * from './components/clima-card/clima-card.component';
export * from './components/clima-observado-form/clima-observado-form.component';
